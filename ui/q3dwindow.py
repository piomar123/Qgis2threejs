...
class Ui_Q3DWindow(object):
    def setupUi(self, Q3DWindow):
        ...
        self.actionLayersVisibility = QtWidgets.QAction(Q3DWindow)
        self.actionLayersVisibility.setObjectName("actionLayersVisibility")
        ...
        self.menuScene.addAction(self.actionLayersVisibility)
    ...
    def retranslateUi(self, Q3DWindow):
        ...
        self.actionLayersVisibility.setText(_translate("Q3DWindow", "Apply layers visibility from project"))
